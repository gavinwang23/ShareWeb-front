    ...
    <ul>
      <li v-for="i in list" :key="i.title">
        <div class="articleTitleBox">
          <router-link :to="{name:'article',params:{article:i}}">
            <b>{{i.articleTitle}}</b>
          </router-link>
        </div>
        <div class="articleContainerBox">
          ...
          <div class="layoutFooter">
            <div class="articleUp articleFooterLi">
              ...
              <router-link :to="{name:'article',params:{article:i}}">{{i.articleAdmire}}</router-link>
            </div>
            <div class="articleDown articleFooterLi">
              <i class="el-icon-caret-bottom"></i>
              <router-link :to="{name:'article',params:{article:i}}">{{i.articleOppose}}</router-link>
            </div>
            ...
            <div class="articleUser articleFooterLi">
              <router-link :to="{name:'article',params:{article:i}}">{{i.userName}}</router-link>
            </div>
          </div>
        </div>
      </li>
